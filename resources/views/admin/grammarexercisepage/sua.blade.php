        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Trang bài tập ngữ pháp
                    <small>{{$grammarexercisepage->grammarlessonpage->TieuDe}}</small>
                </h1>
            </div>
            <!-- /.col-lg-12 -->
            <div class="col-lg-8" style="padding-bottom:120px">
                ...
                <form action="admin/grammarexercisepage/sua/{{$grammarexercisepage->id}}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value ="{{csrf_token()}}"/>
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <table class="table table-striped table-bordered table-hover" >
                            ...
                            <tbody>
                                <tr>
                                    @if($grammarexercisepage->QuestionType==0)
                                    <td>
                                    ...
                                    <td><input required maxlength="100" type="text" value="{{$grammarexercisepage->Question}}" name="question" class="form-control question"></td>
                                    <td><input required maxlength="100" type="text" value="{{$grammarexercisepage->Answer}}" name="answer" class="form-control answer"></td>
                                    @endif
                                    @if($grammarexercisepage->QuestionType==1)
                                    <td>
                                    <select name="questiontype"class="form-control qtype">
                                    ...
                                    <td>
                                        ...
                                        <select name="answer"class="form-control answer">
                                            @if($grammarexercisepage->Answer==True)
